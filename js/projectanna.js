...
const right = document.querySelector(`.Slider-arrows--right`)
//Selecionamos el svg de la flecha hacia la izquierda.
const left = document.querySelector(`.Slider-arrows--left`)
