...
const right = document.querySelector(`.Carrousel-arrows--right`)
//Selecionamos el svg de la flecha hacia la izquierda.
const left = document.querySelector(`.Carrousel-arrows--left`)
//Seleccionamos todas las imágenes llamadas Slider-img.
const cookclonimg = document.querySelectorAll(`.Carrousel-img`)
