...
const right = document.querySelector(`.Clon-arrows--right`)
//Selecionamos el svg de la flecha hacia la izquierda.
const left = document.querySelector(`.Clon-arrows--left`)
//Seleccionamos todas las imágenes llamadas Slider-img.
const clonimg = document.querySelectorAll(`.Clon-img`)
...
right.addEventListener(`click`, ()=>{
    ...
    clonimg.forEach((_ , i)=>{
        ...
        clonimg[i].classList.remove(`isVisible`)
    })
    //Agregamos la classList en función del índice correspondiente.
    clonimg[foto].classList.add(`isVisible`)
})
